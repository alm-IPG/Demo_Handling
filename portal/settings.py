...
SECRET_KEY = 'dev-only-key-change-later' #'django-insecure-1jq5egjaul2sca0o&6w%m=am7(cpon(_*)^7trf^#b5z7=ypwd'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '172.30.10.27']
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [ BASE_DIR / 'demos' / 'static' ]  # 👈 our CSS/JS/images
